...
// var img_height;
$(function () {
    compentent_reset(".Carousel_content", ".Carousel_content_li images");
        compentent_reset(".recommend_blog_ul_li", ".recommend_blog_ul_li images");
        compentent_reset(".knowledge_theme_ul_li", ".knowledge_theme_ul_li images");
...
var init_page = function () {
    ...
    $.ajax({
        url:"/blog/blog/searchRecommendBlog",
        type:"POST",
        success:function (result) {
            var data = result.data;
...
var view_blog = function (obj) {
    ...
    window.location = "/blog/muyu/blog.html?blogCode="+blog_id;
};
...
$(function () {
    $("#key").keydown(function(event) {
        if (event.keyCode == 13) {
            var key = $("#key").val();
            window.location = "/blog/page/html/list.html?key="+key;
        }
    })
})
