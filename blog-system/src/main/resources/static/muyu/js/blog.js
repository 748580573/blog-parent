Vue.use(VueLazyload,{
    preLoad: 1.3,
    error: '/blog/muyu/images/error.jpg',
    loading: '/blog/muyu/images/jiazai.png',
    attempt: 1
});
var blog = new Vue({
    el:"#blog",
...
$(document).ready(function () {
    ...
    $("#key").keydown(function(event) {
        if (event.keyCode == 13) {
            var key = $("#key").val();
            window.location = "/blog/muyu/list.html?key="+key;
        }
    })
});
...
var initPage = function () {
    ...
    $.ajax({
        url:"/blog/comment/searchComment.html",
